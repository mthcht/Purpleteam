...
$subject_list = @("SOC *","[SOC*","SOC-*","*-SOC*","*Alert*","*Incident*","CERT *","High -","*Detection*","*Critical*","*malware*","*suspicious*","*phish*","*Medium*","*suspect*","malicious","*incindent*","*alert*","*detection*","*protect*","*SentinelOne*","*crowdstrike*","*mcafee*","*trellix*","*kaspersky*","*EDR*","*antivirus*","*hack*","*bruteforce*","* scan *","*triggerred*")
