...
import gzip
log_dir = "/var/log/"
honeydir = "/opt/virustotal_report/ssh/bf_list.csv"
...
def extract():
    for log_line in log_file:
        ...
        if "Failed password for" in log_line:
            ...
            if ip_address:
                result.append((date_time_day.group(1), ip_address[0]))
...
result_dict = {}
csv_dict = {}
with open(honeydir,'r') as f_input:
...
print(result_dict)
with open(honeydir,'w') as f_output:
